            ...
            <div className="md:w-1/2  w-full">
              ...
              <Title level={5} className="flex items-center gap-2 my-5">
                ...
                <Caption className="text-lg">
                  {`${product?.length || "*"}"L x ${product?.width || "*"
              ...
              <Title className="flex items-center gap-2 my-5">
                <span
                  className={`px-2 py-1 text-xs font-semibold rounded-full ${product?.isVerify ? "" : "bg-red-500 text-white"
                    } ${product?.isSoldout ? "bg-red-500 text-white" : ""}`}
                >
                  {product?.isSoldout ? "Sold Out" : product?.isVerify ? "" : "Coming Soon"}
                </span>
              </Title>
              <br />
              ...
              <div className="p-5 px-10 shadow-s3 py-8 mt-5">
                ...
                >
                  ...
                  <button
                    type="submit"
                    className={`py-3 px-10 rounded-lg ${product?.isSoldout || !product?.isVerify
